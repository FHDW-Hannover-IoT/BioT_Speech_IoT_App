 ...
 * "Sensor/Zeit") - mqttHandler → onMessageReceived(...) → handleMovement / handleGyro / handleTime
 * - UI TextViews are updated - DB entities (AccelData / GyroData / ValueSensor) are stored.
 */
public class MainActivity extends AppCompatActivity {
    ...
    //  - Gyro                            → gyroX/Y/ZValue
    //  - Zeit timestamp                  → we show in accelZValue for demo (or add a dedicated
    // TextView).
